    ...
    <main role="main" class="container" style="padding-top:80px;">
		...
		<ul class="list-group mb-8">
            <li class="list-group-item  lh-condensed">
                <form action="/home/dispositivo/atualizar?d={{$dispositivo->id}}" method="post">
                @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group label-floating">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="tipo">
                                        <option>{{$dispositivo->tipo}}</option>
                            ...
                            <div class="form-group label-floating">
                                ...
                                <div class="form-group">
                                    <select class="form-control" name="disponivel">
                                        <option value="{{$dispositivo->disponivel}}">
                                            @if($dispositivo->disponivel==1)
                                            Disponivél
                                            @else
                                            Em manutenção
                                            @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group label-floating">
                                ...
                                <div class="form-group">
                                    ...
                                    <option>{{$dispositivo->curso}}</option>
                                        <option>Todos</option>
