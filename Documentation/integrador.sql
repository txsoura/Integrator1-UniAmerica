...
--
-- Host: localhost
-- Generation Time: Dec 05, 2019 at 02:47 AM
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `contato`, `endereco`, `estado`, `cidade`, `curso`, `nivel`) VALUES
...
(2, 'jhgjhg', 'teste@t.c', '$2y$10$eLcDS3VDBpLhd78aWiSn8eUGzFuEtZnQ3imuxrRArQulF3zXT4qSG', 24534654, 'kjghjgkhjgjhdghf', 'Paraná', 'khgjhgfj', 'Administração', 1),
(3, 'teste', 'hkg@khg.c', '$2y$10$Nla/c/K5GDQGuRo5QJ2c6.mDPpVo8o0qHpgChPihpJi7IOcG7f8DK', 2435678, 'gfbnghnhg', 'Estrangeiro', 'fgfgf', 'Engenharia de Software', 1);
